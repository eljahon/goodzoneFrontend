    ...
    return (
        <>
            <SEO
                ...
                description={promo.meta.description || promo.description.replace(/(<([^>]+)>)/gi, "")}
                ...
                <article className="delivery_content">
                    ...
                    <div className="promo_status">
                        ...
                        <div className="status">
                            ...
                            <span className="desc">{getLocaleDate(promo.start_time)} - {getLocaleDate(promo.end_time)}</span>
                        </div>
                    </div>
                </article>
            </section>
...
export async function getServerSideProps({ params, req }) {
    ...
    const urls = [`${process.env.PROMO_API_URL}/${params.id}?lang=${req.i18n.language}`];
