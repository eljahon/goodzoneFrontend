...
export default function Delivery() {
    ...
    useEffect(() => {
        axios
          .get(
            'https://dev.goodzone.uz/v1/page/dostavka'
          )
          .then((response) => {
    ...
    return deliveryInfo && (
        <>
             <SEO 
                ...
                description={deliveryInfo.meta.description || deliveryInfo.description.replace(/(<([^>]+)>)/gi, "")}
                keywords={deliveryInfo.meta.tags}
            />
            <div className="delivery_splash">
                {deliveryInfo.preview_image ? <LazyImage
            ...
            <section className="section_container">
                <article className="delivery_content">
                    <div className="content_block" dangerouslySetInnerHTML={{
