                            ...
                            <div className="inner_wrapper">
                                <form>
                                    ...
                                    <div className="filter_group">
                                        ...
                                        <input type="text" name="amount_from" id="amount_from" placeholder="от" />
                                        <input type="text" name="amount_to" id="amount_to" placeholder="до" />
                                    </div>
                                    <div className="filter_group">
                                        <h5>Бренды</h5>
                                        ...
                                        <div className="check_box">
                                            <input type="checkbox" name="artel" id="artel" />
                                            <label htmlFor="artel">Artel</label>
                                        </div>
                                        <div className="check_box">
                                            <input type="checkbox" name="rosso" id="rosso" />
                                            <label htmlFor="rosso">Rosso</label>
                                        </div>
                                        <div className="check_box">
                                            <input type="checkbox" name="roison" id="roison" />
                                            <label htmlFor="roison">Roison</label>
                                        </div>
                                        <div className="check_box">
                                            <input type="checkbox" name="hisense" id="hisense" />
